	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new Online_CV_Resume_Section_Pro(
				...
				'example_1',
				array(
					'title'    => esc_html__( 'Personal CV Resume', 'personal-cv-resume' ),
					'pro_text' => esc_html__( 'Go Pro',         'personal-cv-resume' ),
					'pro_url'  => 'https://athemeart.com/downloads/personal-cv-resume/',
					'priority'  => 1,
				)
			)
		);
