...
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
  ...
  -- AUTO_INCREMENT pour la table `images` (pour que l'ID se génère tout seul)
ALTER TABLE `images` MODIFY `id_image` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
-- Note : L'ID_image est spécifié ici. Si votre colonne ID_image est en AUTO_INCREMENT
-- et que vous n'avez pas vidée la table, ces insertions pourraient échouer
-- ou modifier les IDs existants si vous désactivez l'auto-incrément temporairement.
-- L'idéal est de les exécuter sur une table vide ou de laisser id_image de côté pour l'auto-incrément.

--
-- Déchargement des données de la table `immochateau`
--

INSERT INTO `immochateau`.`association_img` (`id`, `id_image`, `img_ppal`) VALUES 
('1', '1', '1'),
('2', '2', '1'),
('3', '3', '1'),
('4', '4', '1'),
