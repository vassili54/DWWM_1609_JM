...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 02 fév. 2022 à 01:00
-- Version du serveur :  10.4.11-MariaDB
-- Version de PHP : 7.4.4
-----------------------------------------------------------------

-- SUPPRIMER LA BASE DE DONNEES SI ELLE EXISTE
DROP DATABASE IF EXISTS immochateau;

-- Ceci crée la base de données 'immochateau' si elle n'existe pas encore.
CREATE DATABASE IF NOT EXISTS immochateau;

-- Ceci dit à MySQL : "Toutes les commandes qui suivent doivent s'appliquer à la base de données 'immochateau'."
USE immochateau;
...
INSERT INTO `images` (`id_image`, `titre_image`, `chemin_image`, `texte_alternatif`, `extension`) VALUES
(1, 'Maison Lac Annecy', 'maison_1.jpg', 'Belle maison au bord du lac d''Annecy', 'jpg'),
(2, 'Beau F3 Meuble', 'appartement_1.jpg', 'Beau F3 situé au 1er étage', 'jpg'),
(3, 'Bel appartement', 'appartement_2.jpg', 'Appartement des Maraîchers, Lumineux 4 pièces', 'jpg'),
(4, 'Appartement F2', 'appartement_3.jpg', 'Appartement 2 pièces de 67m2 avec orientation SUD', 'jpg'),
(5, 'Maison 4Pieces', 'maison_2.jpg', 'découvrez cette maison de 4 pièces de 80 m² et de 1 500 m² de terrain.', 'jpg'),
(6, 'Maison mitoyenne', 'maison_3.jpg', 'Idéalement situé à 5 minutes de l''Eurométropole Strasbourgeoise', 'jpg'),
(7, 'Terrain Constructible', 'terrain.jpg', 'Terrain dans un endroit très calme sans vis a vis avec une vue magnifique.', 'jpg'),
(8, 'Grand Appartement', 'appartement_4.jpg', 'Quartier des Maraîchers', 'jpg'),
(9, 'l''olibrius thann', 'appartement_5.jpg', 'Test', 'jpg'),
(10, 'Grand Appartement', 'appartement_6.jpg', 'test', 'jpg');

-- Insertion des données dans la table `association_img`
INSERT INTO `association_img` (`id`, `id_image`, `img_ppal`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(4, 4, 1),
...
-- Générez d'abord le hachage pour votre mot de passe "admin123" (ou un autre mot de passe de votre choix)
-- Exécutez ce code PHP une fois pour obtenir le hachage :
-- <?php echo password_hash('admin123', PASSWORD_DEFAULT); ?>


-- Une fois que vous avez le hachage (par exemple, '$2y$10$abcdefghijklmnopqrstuvwxyz1234567890ABCDEF'),
-- insérez-le dans la requête SQL ci-dessous.

--   USE immochateau; -- Cette ligne dit à la base de données de travailler sur 'immochateau'

-- INSERT INTO `utilisateurs` (`nom_utilisateur`, `prenom_utilisateur`, `mail_utilisateur`, `pass_utilisateur`, `id_niveau`) VALUES
-- ('ADMIN', 'Super', 'superadmin@immochateau.com', '$2y$10$k5VD/Jk7GNIsyHzly8XlqOQN0nSRXhPeM4QIkHA5vLrkVXokqkr62', 1);

-- Exemple avec un hachage fictif pour 'admin123' :
INSERT INTO `utilisateurs` (`nom_utilisateur`, `prenom_utilisateur`, `mail_utilisateur`, `pass_utilisateur`, `id_niveau`) VALUES
('ADMIN', 'Super', 'superadmin@immochateau.com', '$2y$10$abcdefghijklmnopqrstuvwxyz1234567890ABCDEF', 1);

-- DELETE FROM utilisateurs WHERE mail_utilisateur = 'superadmin@immochateau.com';
